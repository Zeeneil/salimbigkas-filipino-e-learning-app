        ...
        <div className="flex flex-wrap mx-auto">
            ...
            <div className="modal2 hidden fixed top-0 left-0 w-full h-full bg-black/80 z-50">
                <div className="relative bg-white p-10 rounded-lg shadow-lg w-96 mx-auto mt-20">
                    ...
                    <form>
                        <div className="mb-4 text-left">
                            <label className="block text-sm font-medium mb-2" htmlFor="firstname">Firstname</label>
                            <input
                                type="text"
                                id="firstname"
                                className="w-full px-3 py-2 border rounded-lg"
                        ...
                        <div className="mb-4 text-left">
                            <label className="block text-sm font-medium mb-2" htmlFor="lastname">Lastname</label>
                            <input
                                type="text"
                                id="lastname"
                                className="w-full px-3 py-2 border rounded-lg"
