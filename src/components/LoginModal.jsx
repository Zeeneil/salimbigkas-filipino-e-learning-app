...
const LoginModal=({ isOpen, onClose, onSwitch })=> {
  ...
  return (
    <div>
      ...
      <main className={`relative flex-1 bg-white py-10 px-15 rounded-lg shadow-lg w-md transform transition-transform duration-300 ${isAnimating ? 'scale-100 translate-y-0' : 'scale-0 translate-y-10'}`}>
        <a
        ...
        <form onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className={`w-full mt-5 bg-[#2C3E50] text-white p-4 rounded-lg shadow-md drop-shadow-lg ${isSigningIn ? 'opacity-50 cursor-not-allowed' : 'hover:font-medium hover:border-[#386BF6] hover:bg-[#34495e]'}`}
          >
        ...
        <button
          ...
          className={`relative w-full flex mt-4 items-center justify-center p-4 border rounded-lg shadow-md drop-shadow-lg ${isSigningIn ? 'cursor-not-allowed' : 'hover:bg-[#e0f2f1] hover:text-[#2C3E50]  hover:border-[#386BF6] transition duration-300 active:bg-[#ecf0f1]'}`}>
